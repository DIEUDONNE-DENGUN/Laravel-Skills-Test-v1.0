        ...
        <div class="card-body">
            ...
            <div class="card-text">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header text-center"> Add a new project to attached tasks to.</div>
                            <div class="card-body">
                                <form class="form-inline text-center" method="POST"
                                    ...
                                    <div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <button type="submit" class="btn btn-primary btn-sm">Save Project
                                                </button>
                                            </div>
                                            <div class="col-md-3"></div>
                                        </div>
