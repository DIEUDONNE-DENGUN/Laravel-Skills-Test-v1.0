                                ...
                                <form class="form-inline text-center" method="POST"
                                    ...
                                    <div>
                                        ...
                                        <div class="row alert">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group mb-2 mr-sm-2">
                                                    <input value="{{$task->priority}}" type="number"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <button type="submit" class="btn btn-primary btn-sm">Update Task
                                                </button>
                                            </div>
                                            <div class="col-md-3"></div>
                                        </div>
