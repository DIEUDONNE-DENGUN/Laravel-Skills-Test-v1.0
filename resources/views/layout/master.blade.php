...
<footer class="footer mt-auto py-3 container">
    <nav class="navbar" style="background-color: #ffff; margin-bottom: -17px; margin-left: 10px;margin-right: 10px">
        <div style="color:rgb(0, 106, 172)">
            &copy; <a style="color:rgb(0, 106, 172)" href="http://go-groups.net" target="_blank">Coalition Technologies</a><br>
            3750 S Robertson Blvd, Suite #200 <br>
        </div>
    </nav>
</footer>
